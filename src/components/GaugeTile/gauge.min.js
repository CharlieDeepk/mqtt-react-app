!(function (e) {
  ...
  function c(e) {
    return (
      ...
      e.majorTicks.length ||
        (e.majorTicks.push(We.formatMajorTickNumber(e.minValue, e)),
        e.majorTicks.push(We.formatMajorTickNumber(e.maxValue, e))),
  ...
  function u(e, t) {
    ...
    if (((e = parseFloat(e)), (l = e < 0), (e = Math.abs(e)), i > 0)) {
      for (
        a = e.toFixed(i).toString().split("."), n = r - a[0].length;
        o < n;
        ++o
      )
        a[0] = "0" + a[0];
  ...
  function x(e, t, i, r, o, n) {
    if (t.valueBox) {
      ...
      t.colorValueBoxShadow &&
        ((e.shadowBlur = 1.2 * c), (e.shadowColor = t.colorValueBoxShadow)),
  ...
  function S(e, t, i, r, o) {
    i.beginPath(),
      i.arc(0, 0, xe(e), 0, 2 * Oe, !0),
      (i.lineWidth = t),
      (i.strokeStyle = o ? We.linearGradient(i, r, o, e) : r),
      i.stroke(),
      i.closePath();
  }
  ...
  function W(e, t) {
    var i = pe.pixelRatio,
      ...
      n =
        o - (t.borderOuterWidth * i) / 2 - (t.borderMiddleWidth * i) / 2 + 0.5,
      a =
        n - (t.borderMiddleWidth * i) / 2 - (t.borderInnerWidth * i) / 2 + 0.5,
      l = V(e, t),
      s = void 0,
      d = !1;
    e.save(),
      t.borderOuterWidth &&
        ((d = We.drawShadow(e, t, d)),
        S(
          o,
          t.borderOuterWidth * i,
          e,
      ...
      for (e.save(); o < n; o++) {
        ...
        e.beginPath(),
          ...
          e.arc(
            ...
            0,
            r,
            We.radians(t.startAngle + (l.from - t.minValue) / a),
            We.radians(t.startAngle + (l.to - t.minValue) / a),
            !1
          ),
  ...
  function A(e, t) {
    ...
    for (
      e.lineWidth = pe.pixelRatio,
        e.strokeStyle = t.colorMinorTicks || t.colorStrokeTicks,
        e.save(),
        t.exactTicks
          ? ((o = t.maxValue - t.minValue),
            (r = s ? o / s : 0),
            (l = (Se.mod(t.majorTicks[0], s) || 0) * d))
          : (r = s * (t.majorTicks.length - 1));
      a < r;
      ++a
    )
      (n = t.startAngle + l + a * (t.ticksAngle / r)) <=
        t.ticksAngle + t.startAngle &&
        (e.rotate(We.radians(n)),
        e.beginPath(),
        e.moveTo(0, i),
      ...
      e.lineWidth = 2 * a,
        ...
        o =
          t.colorMajorTicks instanceof Array
            ? t.colorMajorTicks
            : new Array(n).fill(t.colorStrokeTicks || t.colorMajorTicks),
        r = 0;
      r < n;
      ++r
    )
      (e.strokeStyle = o[r]),
        e.rotate(We.radians(B(t, t.exactTicks ? t.majorTicks[r] : r, n))),
        e.beginPath(),
        e.moveTo(0, i),
        e.lineTo(0, i - 0.15 * e.max),
        C(e);
    t.strokeTicks &&
      ((e.strokeStyle = t.colorStrokeTicks || o[0]),
      e.rotate(Ae),
      e.beginPath(),
      e.arc(
        0,
        ...
        We.radians(t.startAngle + t.ticksAngle),
        !1
      ),
      C(e));
  }
    ...
    var i = P(e, t) - 0.15 * e.max,
      ...
      l =
        t.colorNumbers instanceof Array
          ? t.colorNumbers
          : new Array(n).fill(t.colorNumbers),
      s = a
        ? (-(t.value - t.minValue) / (t.maxValue - t.minValue)) * t.ticksAngle
        : 0;
    for (
      a && (e.save(), e.rotate(-We.radians(s))),
        e.font = We.font(t, "Numbers", e.max / 200),
        e.lineWidth = 0,
        e.textAlign = "center",
      ...
      360 === d && (d = 0),
        r[d] ||
          ((r[d] = !0),
          (e.fillStyle = l[o]),
          e.fillText(t.majorTicks[o], f.x, f.y));
    }
    a && e.restore();
  }
  ...
  function N(e, t) {
    t.title &&
      (e.save(),
      (e.font = We.font(t, "Title", e.max / 200)),
  ...
  function E(e, t) {
    t.units &&
      (e.save(),
      (e.font = We.font(t, "Units", e.max / 200)),
      (e.fillStyle = t.colorUnits),
      (e.textAlign = "center"),
      e.fillText(We.formatContext(t, t.units), 0, e.max / 3.25, 0.8 * e.max),
      e.restore());
  }
  ...
  function _(e, t) {
    if (t.needle) {
      ...
      var o = V(e, t),
        ...
        a = xe((o / 100) * t.needleCircleSize * 0.75),
      ...
      e.save(),
        We.drawNeedleShadow(e, t),
        e.rotate(We.radians(r)),
  ...
  function R(e, t, i) {
    We.drawValueBox(e, t, i, 0, e.max - 0.33 * e.max, e.max);
  }
  ...
  function I(e) {
    var t = e.startAngle,
      ...
      o =
        t +
        ((We.normalizedValue(e).normal - e.minValue) /
          (e.maxValue - e.minValue)) *
          e.ticksAngle;
    if ("middle" === e.barStartPosition) {
      var n = 0.5 * (e.minValue + e.maxValue);
      e.value < n
        ? ((r =
            180 -
            ((n - We.normalizedValue(e).normal) / (e.maxValue - e.minValue)) *
              e.ticksAngle),
          (o = 180))
        : ((r = 180),
          (o =
            180 +
            ((We.normalizedValue(e).normal - n) / (e.maxValue - e.minValue)) *
              e.ticksAngle));
  ...
  function D(e, t) {
    ...
    if (
      ...
      o &&
        (e.beginPath(),
        e.arc(0, 0, s, We.radians(c) - d, We.radians(h) + d, !1),
      ...
      n &&
        (e.beginPath(),
        e.arc(0, 0, s, We.radians(c), We.radians(h), !1),
        ...
        t.barShadow &&
          (e.beginPath(),
          e.arc(0, 0, r, We.radians(c), We.radians(h), !1),
          e.clip(),
          e.beginPath(),
          (e.strokeStyle = t.colorBar),
          (e.lineWidth = 1),
      ...
      var u = I(t),
        ...
        m = u.endAngle;
      e.beginPath(),
        e.arc(0, 0, s, We.radians(f), We.radians(m), !1),
  ...
  function L(e, t, i, r, o, n, a, l) {
    e.beginPath(),
      (e.fillStyle = l
        ? We.linearGradient(e, a, l, o > n ? o : n, n > o, o > n ? i : r)
        : a),
      t > 0 ? We.roundRect(e, i, r, o, n, t) : e.rect(i, r, o, n),
      e.fill(),
      e.closePath();
  }
  ...
  function G(e, t, i, r, o, n, a, l, s) {
    e.beginPath(),
      (e.lineWidth = t),
      (e.strokeStyle = s ? We.linearGradient(e, l, s, a, !0, o) : l),
      i > 0 ? We.roundRect(e, r, o, n, a, i) : e.rect(r, o, n, a),
      e.stroke(),
      e.closePath();
  }
  ...
  function F(e, t, i, r, o, n) {
    ...
    return (
      t.borderOuterWidth &&
        ((T = We.drawShadow(e, t, T)),
        G(
          e,
          t.borderOuterWidth * a,
          l,
          i + (t.borderOuterWidth * a) / 2 - x,
          r + (t.borderOuterWidth * a) / 2 - x,
          s,
          u,
          t.colorBorderOuter,
          t.colorBorderOuterEnd
      ...
      t.borderMiddleWidth &&
        ...
        G(
          e,
          t.borderMiddleWidth * a,
          (l -= 1 + 2 * x),
          g + (t.borderMiddleWidth * a) / 2 - x,
          w + (t.borderMiddleWidth * a) / 2 - x,
          d + 2 * x,
          f + 2 * x,
          t.colorBorderMiddle,
          t.colorBorderMiddleEnd
      ...
      t.borderInnerWidth &&
        ...
        G(
          e,
          t.borderInnerWidth * a,
          (l -= 1 + 2 * x),
          b + (t.borderInnerWidth * a) / 2 - x,
          k + (t.borderInnerWidth * a) / 2 - x,
          c + 2 * x,
          m + 2 * x,
          t.colorBorderInner,
          t.colorBorderInnerEnd
        ...
        (x += 0.5 * a)),
      We.drawShadow(e, t, T),
      L(e, l, p, y, h + 2 * x, v + 2 * x, t.colorPlate, t.colorPlateEnd),
      e.restore(),
      [p, y, h, v]
    );
  }
  ...
  function X(e, t, i, r, o, n) {
    ...
    var g = 2 * t.barStrokeWidth,
      ...
      T =
        !l || (t.hasLeft && t.hasRight)
          ? 0
          : (((t.hasRight ? -1 : 1) * t.ticksWidth) / 100) * s,
      S =
        l || (t.hasLeft && t.hasRight)
          ? 0
          : (((t.hasRight ? -1 : 1) * t.ticksWidth) / 100) * s;
  ...
  function Y(e, t, i, r, o, n, a) {
    ...
    if ((e.save(), e.beginPath(), t.barBeginCircle)) {
      ...
      "progress" === i &&
        (h =
          e.barDimensions.barOffset +
          ((h - e.barDimensions.barOffset) *
            (We.normalizedValue(t).normal - t.minValue)) /
            (t.maxValue - t.minValue));
      var P = ye(S + h - e.barDimensions.barOffset + u / 2),
        M = ye(V - h + e.barDimensions.barOffset - u / 2);
      e.arc(v, g, m, k + y, k - y),
        s
          ? (e.moveTo(S, A), e.lineTo(S, M), e.lineTo(O, M), e.lineTo(O, A))
          : (e.moveTo(S, A), e.lineTo(P, A), e.lineTo(P, V), e.lineTo(S, V));
    } else {
      var B = ye(s ? b + (d - c) / 2 : b + f),
        C = ye(s ? p + h + f : p + (d - c) / 2);
      "progress" === i &&
        (h *= (t.value - t.minValue) / (t.maxValue - t.minValue)),
        s ? e.rect(B, C, c, -h) : e.rect(B, C, h, c);
    }
    "progress" !== i &&
      t.barStrokeWidth &&
      ((e.lineWidth = u), (e.strokeStyle = t.colorBarStroke), e.stroke()),
      "progress" !== i && t.colorBar
        ? ((e.fillStyle = t.colorBarEnd
            ? We.linearGradient(e, t.colorBar, t.colorBarEnd, h, s, s ? p : b)
            : t.colorBar),
          e.fill())
        : "progress" === i &&
          t.colorBarProgress &&
          ((e.fillStyle = t.colorBarProgressEnd
            ? We.linearGradient(
                e,
                t.colorBarProgress,
                t.colorBarProgressEnd,
                w,
                s,
                s ? p : b
              )
    ...
    if (t.highlights && f) {
      ...
      for (e.save(); g < b; g++) {
        ...
        e.beginPath(),
          (e.fillStyle = V.color),
          r
            ? (m && e.rect(k - T, x - W, y, -O),
              v && e.rect(k + S, x - W, y, -O))
            : (m && e.rect(k + W, x - T, O, y),
              v && e.rect(k + W, x + S, O, y)),
          e.fill(),
          e.closePath();
      }
    }
  ...
  function $(e, t, i, r, o, n, a, l, s) {
    ...
    for (var B = w / (o - r); S < V; S++)
      (W = i[S]),
        (e.strokeStyle = M[S]),
        c
          ? ((T = p + h - m - f + (r - W) * B),
            n && ((x = b + A), Z(e, x, T, ye(x - O), T)),
            a && ((x = b + P), Z(e, x, T, ye(x - O), T)))
          : ((x = b + m + f - (r - W) * B),
            n && ((T = p + A), Z(e, x, T, x, ye(T - O))),
            a && ((T = p + P), Z(e, x, ye(T), x, T - O)));
  }
  ...
  function K(e, t) {
    var i = We.prepareTicks(t),
      ...
      s =
        t.colorMajorTicks instanceof Array
          ? t.colorMajorTicks
          : new Array(t.majorTicks.length).fill(
              t.colorStrokeTicks || t.colorMajorTicks
            );
    if (
      ($(
        e,
      ...
      (e.strokeStyle = t.colorStrokeTicks || s[0]),
        ...
        c
          ? ((S = b + h - m - v + a / 2),
            (W = S - p - a),
            o && ((V = T = ye(g + x)), Q(e, T, S, V, W)),
            n && ((V = T = ye(g + y)), Q(e, T, S, V, W)))
          : ((T = g + m + v - a / 2),
            (V = T + p + a),
            o && ((W = S = ye(b + x)), Q(e, T, S, V, W)),
            n && ((W = S = ye(b + y)), Q(e, T, S, V, W)));
    }
  }
  ...
  function ee(e, t) {
    ...
    if (s)
      if (t.exactTicks)
        for (var c = Se.mod(t.majorTicks[0], s) || 0; l < t.maxValue; l += s)
          c + l < t.maxValue && a.push(c + l);
      else for (; l < t.maxValue; l += d) a.push(l);
    $(
      e,
      t.colorMinorTicks || t.colorStrokeTicks,
      a,
      t.minValue,
      t.maxValue,
      o,
  ...
  function te(e, t) {
    var i = e.barDimensions,
      ...
      A =
        t.colorNumbers instanceof Array
          ? t.colorNumbers
          : new Array(g).fill(t.colorNumbers),
      P = (t.numbersMargin / 100) * n;
    for (
      e.font = We.font(t, "Numbers", n / 200),
        e.lineWidth = 0,
        e.textAlign = "center";
      k < g;
      k++
      ...
      (e.fillStyle = A[k]),
        (O = t.majorTicks[k]),
        (W = t.exactTicks ? h * ((v[k] - t.minValue) / f) : (k * h) / (g - 1)),
        r
          ? ((V = c + o - l - s - W + w / 3),
            b && ((e.textAlign = "right"), e.fillText(O, d + x - P, V)),
            p && ((e.textAlign = "left"), e.fillText(O, d + T + P, V)))
          : (e.measureText(O).width,
            (S = d + l + s + W),
            b && e.fillText(O, S, c + x - P),
            p && e.fillText(O, S, c + T + w + P));
  }
  ...
  function ie(e, t) {
    if (t.title) {
      var i = e.barDimensions,
        ...
        c = ye(a + (r ? o : n) / 2),
        h = ye(l + s / 2 - (r ? d : d / 2) - 0.025 * (r ? n : o));
      e.save(),
        (e.textAlign = "center"),
        (e.fillStyle = t.colorTitle),
        (e.font = We.font(t, "Title", o / 200)),
        (e.lineWidth = 0),
  ...
  function re(e, t) {
    if (t.units) {
      ...
      e.save(),
        (e.textAlign = "center"),
        (e.fillStyle = t.colorUnits),
        (e.font = We.font(t, "Units", o / 200)),
        (e.lineWidth = 0),
        e.fillText(We.formatContext(t, t.units), c, h, r ? o : n);
    }
  }
  ...
  function oe(e, t) {
    if (t.needle) {
      var i = e.barDimensions,
        ...
        m = "left" !== t.needleSide,
        v =
          (d * (We.normalizedValue(t).indented - t.minValue)) /
          (t.maxValue - t.minValue),
      ...
      e.save(),
        ...
        r
          ? ((y = ye(h + n - s - l - v)),
            f && ((w = ye(c + W)), (k = w + p), T(e, t, w, y, k, y, p)),
            m && ((w = ye(c + O)), (k = w - p), T(e, t, w, y, k, y, p, !0)))
          : ((w = ye(c + s + l + v)),
            f && ((y = ye(h + W)), (x = y + p), T(e, t, w, y, w, x, p)),
            m && ((y = ye(h + O)), (x = y - p), T(e, t, w, y, w, x, p, !0))),
        e.restore();
    }
  }

  function ne(e, t, i, r) {
    return t.colorNeedleEnd
      ? We.linearGradient(
          e,
          r ? t.colorNeedleEnd : t.colorNeedle,
          r ? t.colorNeedle : t.colorNeedleEnd,
          i,
          !e.barDimensions.isVertical
        )
      : t.colorNeedle;
  }
  ...
  function se(e, t, i, r, o, n, a) {
    var l = ((parseFloat(t.fontValueSize) || 0) * n) / 200,
      s = (0.11 * a - l) / 2;
    e.barDimensions.isVertical &&
      We.drawValueBox(e, t, i, r + n / 2, o + a - l - s, n);
  }
  var de = (function () {
      function e(e, t) {
        var i = [],
    ...
    Object.defineProperty(Object, "assign", {
      ...
      value: function (e, t) {
        ...
        for (var i = Object(e), r = 1; r < arguments.length; r++) {
          ...
          if (void 0 !== o && null !== o)
            for (
              var n = Object.keys(Object(o)), a = 0, l = n.length;
              a < l;
              a++
            ) {
              var s = n[a],
        ...
        value: function (e) {
          ...
          for (
            var t = Object(this),
              ...
              r = arguments[1],
              o = r >> 0,
              n = o < 0 ? Math.max(i + o, 0) : Math.min(o, i),
              a = arguments[2],
              l = void 0 === a ? i : a >> 0,
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  ...
                  n.draw && n.draw(),
                  this.isObservable
                    ? ((n.observer = new MutationObserver(function (r) {
  ...
  var Se = (function (t) {
    function n(t) {
      ...
      if (
        (Te.push(r),
        t.listeners &&
          Object.keys(t.listeners).forEach(function (e) {
            (t.listeners[e] instanceof Array
              ? t.listeners[e]
              : [t.listeners[e]]
            ).forEach(function (t) {
              r.on(e, t);
        ...
        (r.type = e[a] || n),
        (r.initialized = !1),
        (t.minValue = parseFloat(t.minValue)),
        (t.maxValue = parseFloat(t.maxValue)),
        (t.value = parseFloat(t.value) || 0),
        t.borders ||
          (t.borderInnerWidth = t.borderMiddleWidth = t.borderOuterWidth = 0),
        !t.renderTo)
      )
        throw TypeError(
          "Canvas element was not specified when creating the Gauge object!"
        );
      var l = t.renderTo.tagName
        ? t.renderTo
        : document.getElementById(t.renderTo);
      if (!(l instanceof HTMLCanvasElement))
        throw TypeError("Given gauge canvas element is invalid!");
      return (
        (t.width = parseFloat(t.width) || 0),
        (t.height = parseFloat(t.height) || 0),
        (t.width && t.height) ||
          (t.width ||
            (t.width = l.parentNode ? l.parentNode.offsetWidth : l.offsetWidth),
          t.height ||
            (t.height = l.parentNode
              ? l.parentNode.offsetHeight
              : l.offsetHeight)),
        (r.options = t || {}),
        r.options.animateOnInit &&
          ((r._value = r.options.value),
          (r.options.value = r.options.minValue)),
        (r.canvas = new pe(l, t.width, t.height)),
        (r.canvas.onRedraw = r.draw.bind(r)),
        (r.animation = new ge(t.animationRule, t.animationDuration)),
        r
      );
    }
    return (
            ...
            value: function (e) {
              ...
              if (t) {
                for (/Gauge$/.test(t) || (t += "Gauge"); r < o; r++)
                  n[be.toCamelCase(i[r].name.replace(/^data-/, ""), !1)] =
                    be.parse(i[r].value);
  ...
  void 0 !== e &&
    ((e.BaseGauge = Se), (e.gauges = (window.document || {}).gauges = Te));
    ...
    Me = (function (e) {
      function t(e) {
        return (
          ...
          i(
            this,
            (t.__proto__ || Object.getPrototypeOf(t)).call(this, t.configure(e))
          )
        );
      }
      return (
        ...
        ue(
          ...
          [
            ...
            },
            {
              key: "value",
              set: function (e) {
                (e = Se.ensureValue(e, this.options.minValue)),
                ...
                try {
                  ...
                  if (!e.elementClone.initialized) {
                    ...
                    d.clearRect(r, o, a, l),
                      d.save(),
                      this.emit("beforePlate"),
                      (this.drawBox = F(d, s, r, o, a, l)),
                      this.emit("beforeBar"),
                      U.apply(void 0, [d, s].concat(t(this.drawBox))),
                  ...
                  this.canvas.commit(),
                    ...
                    e.context.save(),
                    this.emit("beforeProgressBar"),
                    H.apply(void 0, [e.context, s].concat(t(this.drawBox))),
                    this.emit("beforeNeedle"),
                    oe(e.context, s),
                    this.emit("beforeValueBox"),
                    se.apply(
                      ...
                      [
                        e.context,
                        s,
                        s.animatedValue ? this.options.value : this.value,
                      ].concat(t(this.drawBox))
                    ),
                    ce(
          ...
          [
            {
              ...
              value: function (e) {
                return (
                  e.barStrokeWidth >= e.barWidth &&
                    (e.barStrokeWidth = ye(e.barWidth / 2)),
                  (e.hasLeft = q("right", e)),
                  (e.hasRight = q("left", e)),
  ...
  void 0 !== e && (e.LinearGauge = Ce),
    Se.initialize("LinearGauge", Be),
